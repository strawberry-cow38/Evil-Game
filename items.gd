...
const DEFS := {
	...
	"ammo_12ga":      {"name": "12 Gauge Buckshot", "weight": 0.045, "value":  3, "color": Color(0.65, 0.10, 0.10), "kind": "ammo", "damage": 70, "falloff_start":  12.0, "falloff_end":  50.0, "damage_min": 22, "desc": "12 gauge buckshot. Devastating up close, falls off fast."},

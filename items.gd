...
const DEFS := {
	...
	"att_762nato_silencer": {"name": "7.62 NATO Silencer", "weight": 0.55, "value": 260, "color": Color(0.10, 0.10, 0.10), "kind": "attachment", "fits_tag": "m700_muzzle", "mods": {"velocity_mult": 0.80, "damage_mult": 0.80, "bloom_mult": 1.10}, "desc": "Heavy 7.62 NATO can for the M700. Quieter, but slower, weaker, sloppier."},

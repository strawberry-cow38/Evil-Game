...
const DEFS := {
	...
	"aug":    {"name": "Steyr AUG",    "weight": 3.60, "value":  460, "color": Color(0.30, 0.40, 0.22), "kind": "weapon", "desc": "Austrian bullpup 5.56. Built-in 1.5× optic. Smooth, flat shooter.", "slots": [{"id":"Muzzle","tag":"m16_muzzle"},{"id":"Mag","tag":"m16_mag"}]},

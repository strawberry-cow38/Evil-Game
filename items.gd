...
const DEFS := {
	...
	"minigun":{"name": "M134 Minigun", "weight": 30.00,"value": 4500, "color": Color(0.18, 0.18, 0.20), "kind": "weapon", "desc": "6-barrel 7.62 NATO Gatling. 3000 RPM cyclic. 1500-round link box. Crushing weight, no spin-up — yet.", "slots": [{"id":"Bipod","tag":"lmg_bipod"}]},

...
const DEFS := {
	...
	"aa12":           {"name": "AA-12",          "weight": 5.70, "value": 950, "color": Color(0.18, 0.18, 0.20), "kind": "weapon", "desc": "Full-auto 12 gauge shotgun. 8-round box mag, gas-operated. Low felt recoil, devastating volume of fire.", "slots": []},

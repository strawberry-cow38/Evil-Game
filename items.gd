...
const DEFS := {
	...
	"minigun":{"name": "M134 Minigun", "weight": 30.00,"value": 4500, "color": Color(0.18, 0.18, 0.20), "kind": "weapon", "desc": "6-barrel 7.62 NATO Gatling. 1500 RPM cyclic, 300-round belt. Hold RMB to spin up (no firing until full). Spin locks you to half speed + no jump.", "slots": [{"id":"Bipod","tag":"lmg_bipod"}]},

...
# Right-side picker panel for the Objects → Objects tool. Mirror of the
# effects panel; emits object_picked(id) when the user selects an entry.
# Subsequent E presses drop a wireframe box of that object into the
# world.

const REGISTRY := preload("res://editor_objects_registry.gd")

signal object_picked(id: String)
